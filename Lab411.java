...
public class Lab411 extends JFrame {
    private JTextField txt1;
    private JPasswordField txt2;//These variables represent text fields where the user can enter a username (txt1) and a password (txt2).
